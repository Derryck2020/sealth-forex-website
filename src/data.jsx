...
export const news_items = [
	{
		...
		img: money,
		url: '#',
		title: 'how much do you need to start trading forex?',
		text: 'Understand the basics of Forex trading, including key concepts like currency ...',
		admin: 'dailyfin',
	...
	},
	{
		...
		img: apple,
		url: '#',
		title: `"We would never crush creativity"`,
		text: `Apple's disatrous iPad ad mocked by rival Samsung in new 43-second spot ...`,
		admin: 'fortune',
		date: 'May 16, 2024',
	},
	{
		...
		img: sp_500,
		url: '#',
		title: 'Dow Jones tickles 40,000 retreating',
		text: 'Dow touches 40,000 before retreating as walmart jumps on earnings ...',
		admin: `investor's`,
		date: 'April 21, 2024',
	},
	{
		...
		img: gold,
		url: '#',
		title: 'Barrick Gold Corporation (GOLD) is Attracting Investor Attention',
		text: 'Over the past month, shares of this gold and copper mining company have returned...',
		admin: `zacks`,
		date: 'May 9, 2024',
	},
	{
		...
		img: hyundai,
		url: '#',
		title: `Chef Corey Lee to Unveil New Restaurant at Hyundai Motor Group`,
		text: `Hyundai to collaborate with the world's first Korean chef to earn Three Michelin ...`,
		admin: `Newswire`,
		date: 'May 9, 2024',
	},
	{
		...
		img: meeting,
		url: '#',
		title: 'How to start investing in crypto: Strategist',
		text: 'Ric Edelman, founder of the Digital Assets Council of Financial Professionals, joins ...',
		admin: `yahoo. fin.`,
		date: 'May 14, 2024',
	},
];
